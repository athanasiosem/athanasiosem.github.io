if ("undefined" == typeof jQuery) throw new Error("Bootstrap requires jQuery"); + function (t) {
    "use strict";
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (s) {
                var h = this.$element.parent(),
                    ...
                    d = "body" == this.options.container ? window.innerHeight : h.outerHeight(),
                    u = "body" == this.options.container ? 0 : h.offset().left;
                o = "bottom" == o && a.top + a.height + l - f > d ? "top" : "top" == o && a.top - f - l < 0 ? "bottom" : "right" == o && a.right + r > c ? "left" : "left" == o && a.left - r < u ? "right" : o, i.removeClass(p).addClass(o)
            }
...
function (t) {
    ! function (t, e, i, o, n, s, a) {
        ...
        }, t[n].l = 1 * new Date, s = e.createElement(i), a = e.getElementsByTagName(i)[0], s.async = 1, s.src = o, a.parentNode.insertBefore(s, a)
    }(window, document, "script", "http://www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-12717486-3", "athanasiosem.github.io"), ga("send", "pageview"), t("#affix").affix({
        offset: {
            top: 500
        }
...
$("#contact-button").click(function () {
    document.location.href = "mailto:athanasisoem@inbox.com";
});
